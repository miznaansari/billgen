...
const resizeBase64Image = (base64, maxWidth = 300) => {
  return new Promise((resolve) => {
    ...
    img.onload = () => {
      ...
      resolve(canvas.toDataURL("image/png", 0.7)); // compress
    };
  });
};
    autoTable(doc, {
...
// console.log('companyInfo?.digitalSignature',companyInfo?.digitalSignature)
    // --- FOOTER SECTION ---
    // Notes Box
    doc.setTextColor(...goldColor);
    doc.setFontSize(8);
